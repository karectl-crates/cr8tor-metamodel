# Contributing to cr8tor-metamodal

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cr8tor-metamodal. These guidelines are not strict rules.
...
The cr8tor-metamodal team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cr8tor-metamodal technical leads
...
[issues]: https://github.com/karectl-crates/cr8tor-metamodal/issues/
[pulls]: https://github.com/karectl-crates/cr8tor-metamodal/pulls/
